...
{
    getRobotPose().theSampleSet.clear();
    for (unsigned int i = 0; i < theSampleSet.numberOfParticles; i++)
    {
        Sample& sample = theSampleSet[i];
        getRobotPose().theSampleSet.push_back(sample);
    }
