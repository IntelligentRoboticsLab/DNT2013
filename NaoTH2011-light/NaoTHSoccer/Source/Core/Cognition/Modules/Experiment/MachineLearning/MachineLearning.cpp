                                          ...
                                          std::ostream &outstream)
{
    if(strcmp(command, "machinelearning:method1") == 0)
    {
        ...
        if (arguments.find("on")!=arguments.end()) {
            ...
            std::list<Test> theTests =  ltw.theTests;

            if (strcmp(arguments.at("Task1"),"on") == 0) theTests.push_back(Test(runningTime, Pose2D(0,10000,0)));
            if (strcmp(arguments.at("Task2"),"on") == 0) theTests.push_back(Test(runningTime/4, Pose2D(0,1000,0)));
            if (strcmp(arguments.at("Task3"),"on") == 0) theTests.push_back(Test(runningTime/4, Pose2D(Math::fromDegrees(30),500,0)));
            if (strcmp(arguments.at("Task4"),"on") == 0) theTests.push_back(Test(runningTime/4, Pose2D(Math::fromDegrees(-30),500,0)));
